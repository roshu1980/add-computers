<?php
class Cmsmart_Dailydeal_Block_Manage_Alldeal_Edit_Tab_Listorder extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        if(!Mage::registry('deal')){
            $deal = Mage::getModel('dailydeal/dailydealproducts')->load($this->getRequest()->getParam('id'));
		...
		$collection->addFieldToFilter('dailydeals', array('finset'=>$deal_id));
    ...
    {
        return $this->getData('grid_url') ? $this->getData('grid_url') : $this->getUrl('*/*/sales', array('_current'=>true));
    }
