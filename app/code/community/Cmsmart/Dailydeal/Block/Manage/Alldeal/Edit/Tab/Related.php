...
class Cmsmart_Dailydeal_Block_Manage_Alldeal_Edit_Tab_Related extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _getSelectedProducts() {
        ...
        if (is_null($products)) {
            $collection = Mage::getModel('dailydeal/related')->getCollection()
                    ->addPostFilter(Mage::registry('dailydeal_data')->getId());
