...
class Cmsmart_Dailydeal_Block_Manage_Dailydeal_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
        ...
        if (Mage::getSingleton('adminhtml/session')->getDailydealData()) {
           ...
           // Mage::registry('dailydeal_data')->setTags(Mage::helper('dailydeal')->convertSlashes(Mage::registry('dailydeal_data')->getTags()));
			Mage::registry('dailydeal_data')->setData('stores', explode(',', $data->getData('storeidlist')));
			...
			// print_r(Mage::registry('dailydeal_data')->getData());
        }
