...
abstract class Netresearch_OPS_Model_Payment_DirectLink extends Netresearch_OPS_Model_Payment_Abstract
{
    ...
    /**
     * Saves the payment model and runs the request to Barclaycards webservice
     *
    ...
    /**
     * Perform necessary preparation before request to Barclaycard is sent
     *
     * @param Mage_Sales_Model_Quote $quote
     * @param Varien_Object $payment
    ...
    public function capture(Varien_Object $payment, $amount)
    {
        ...
        /**
         * invoice request authorize mode if the payment was placed on Barclaycard side
         */
    ...
    protected function invokeRequestParamValidation($requestParams)
    {
        ...
        if (false == $validator->isValid($requestParams)) {
            ...
            Mage::throwException($this->getHelper()->__('The data you have provided can not be processed by Barclaycard'));
        }
