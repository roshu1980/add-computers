...
class Netresearch_OPS_Model_Status_Transition
{
    ...
    /**
     * processes the Barclaycard responses
     *
     * @param array                  $opsResponse
    ...
    /**
     * process the feedback from Barclaycard for capture operations
     *
     * @return $this
     */
    ...
    /**
     * processes the feedback from Barclaycard for void operations
     *
     * @return $this
     */
    ...
    /**
     * processes the feedback from Barclaycard for refund operations
     *
     * @return $this
     */
    ...
    /**
     * retrieves the Barclaycard status for the payment
     *
     * @return string | null the Barclaycard status for the payment
     */
    ...
    /**
     * return the Barclaycard's payment identifier
     *
     * @return string | null the Barclaycard's payment identifier
     */
    ...
    /**
     * retrieves the sub payid from Barclaycard's response
     *
     * @return null| string the payment sub identifier from Barclaycard
     */
    ...
    protected function saveCaptureTxn()
    {
        $this->getDirectlinkHelper()->directLinkTransact(
            ...
            $this->getDataHelper()->__('Start Barclaycard %s capture request', $this->infoArr['type'])
        );
    }
    ...
    /**
     * processes the feedback from Barclaycard
     */
